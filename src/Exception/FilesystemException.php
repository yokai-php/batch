...
class FilesystemException extends RuntimeException
{
    ...
    {
        return new self(
            sprintf('Cannot create dir "%s".', $path)
        );
    }
    ...
    {
        return new self(
            sprintf('Cannot read "%s" file content.', $path)
        );
    }
    ...
    {
        return new self(
            sprintf('Cannot write content to file "%s".', $path)
        );
    }
    ...
    {
        return new self(
            sprintf('Unable to remove file "%s".', $path)
        );
    }
